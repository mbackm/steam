        ...
        (function() {
			...
			*/
                        ...
                        if (settings.spellControl) {
							...
							selex.style.textAlignLast = "center";
        ...
        (function() {
            ...
            function AI() {
                ...
                function bAttack(t) {
                    ...
                    if (enableUseImperil && !GM_getValue('meleeMode')) {
				...
				*/
                ...
                if ((checkForBuff('channeling') && (isSOL || (getSelfHealth() > vHealUseBuff && getSelfSpirit() > vSpiritUseBuff))) || getSelfMana() > 190 || (getGem() == 'mana' && getSelfMana() > 160)) {
